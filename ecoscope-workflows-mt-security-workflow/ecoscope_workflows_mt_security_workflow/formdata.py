...
class ProcessEvents(BaseModel):
    filter_events: Optional[FilterEvents] = Field(
        None, title="Filter Event Coordinates"
    )
...
class FormData(BaseModel):
    ...
    get_event_data: Optional[GetEventData] = Field(None, title="Get Illegal Events")
    ...
    Generate_Map: Optional[GenerateMap] = Field(
        None,
        alias="Generate Map",
        description="Generate point map of illegal events colored by event type.",
    )
    sitrep_report: Optional[SitrepReport] = Field(None, title="Create Security Report")
